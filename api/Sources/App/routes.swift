...
public func routes(_ app: Application) throws {
    ...
    authed.get("storage", "items", use: listStorageItems)
    authed.post("storage", "items", use: createStorageItem)
    authed.get("storage", "items", ":itemID", use: getStorageItem)
    authed.patch("storage", "items", ":itemID", use: updateStorageItem)
    authed.post("storage", "items", ":itemID", "merge", use: mergeStorageItem)
    authed.delete("storage", "items", ":itemID", use: deleteStorageItem)
    authed.post("storage", "items", ":itemID", "entries", use: createStorageEntry)
    authed.post("storage", "entries", "move-own", use: moveOwnStorageEntries)
    authed.patch("storage", "entries", ":entryID", use: updateStorageEntry)
    authed.delete("storage", "entries", ":entryID", use: deleteStorageEntry)
    authed.get("storage", "locations", use: listStorageLocations)
    ...
    authed.patch("item-search", "requests", ":requestID", "resources", use: updateItemSearchRequestResources)
    authed.delete("item-search", "requests", ":requestID", use: deleteItemSearchRequest)
    authed.post("item-search", "requests", ":requestID", "fulfill-from-entry", use: fulfillItemSearchRequestFromEntry)
